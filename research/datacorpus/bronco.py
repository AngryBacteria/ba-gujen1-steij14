...
# Parse the XML data
root = ET.parse("F:\\OneDrive - Berner Fachhochschule\\Dokumente\\UNI\\Bachelorarbeit\datensets\\bronco\\BRONCO150.xml").getroot()
...
for passage in root.iter('passage'):
    ...
    for annotation in passage.findall('annotation'):
        ...
        print(f'Annotation ID: {annotation_id}, Type: {annotation_type}, Text: {annotation_text}, Offset: {offset}, Length: {length}')